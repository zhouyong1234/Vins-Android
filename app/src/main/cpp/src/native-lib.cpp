...
//const std::string path = "/storage/emulated/0/VINS/img_imu_data/";

extern "C"
JNIEXPORT void JNICALL
Java_com_example_vins_VinsJNI_init(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vins_VinsJNI_onImageAvailable(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vins_VinsJNI_onPause(JNIEnv *env, jclass type) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vins_VinsJNI_updateViewInfo(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vins_VinsJNI_onARSwitch(JNIEnv *env, jclass type,
        jboolean isChecked) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vins_VinsJNI_onLoopSwitch(JNIEnv *env, jclass type,
        jboolean isChecked) {
